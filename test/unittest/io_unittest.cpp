...
TEST(IO, OpenText)
{
    ...
    s = ney::open<char>("./examples/chars1.txt");
    ...
    s = ney::open<char>("./examples/chars1.txt").output(o).as_text();
...
TEST(IO, OpenNumbers)
{
    ...
    s = ney::open<int>("./examples/ints1.txt").output(o);
    ...
    s = ney::open<double>("./examples/doubles1.txt").output(od);
